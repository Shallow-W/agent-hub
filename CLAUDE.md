...
6. **Review 通过后更新文档**：检查本次任务是否涉及需要文档化的内容（新增结构体/接口、API 变更、架构调整等），如有则同步更新 `doc/` 下的设计文档、API 文档或数据模型文档，遵循 `doc/harness/doc-conventions.md` 中的文档编写规范。文档更新产生的 commit 不再触发步骤 5
