...
- Git分支/提交规范：`doc/conventions/git-conventions.md`
- 前端React/TS编码规范：`doc/conventions/frontend-conventions.md`
- 后端Go编码规范：`doc/conventions/backend-conventions.md`
- Monorepo目录结构与文件命名：`doc/conventions/project-structure.md`
- 文档编写规范：`doc/conventions/doc-conventions.md`
